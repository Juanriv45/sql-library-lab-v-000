...
def select_series_title_with_most_human_characters
  "SELECT series.title FROM series JOIN characters ON series.id = characters.series_id WHERE characters.species = 'human' GROUP BY count(characters.species) ORDER BY characters.species DESC LIMIT 1;"
end
