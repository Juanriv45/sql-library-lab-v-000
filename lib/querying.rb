...
def select_series_title_with_most_human_characters
  "SELECT series.title FROM series INNER JOIN characters ON series.id = characters.series_id ORDER BY count(characters.pecies) WHERE characters.species = 'human';"
end
