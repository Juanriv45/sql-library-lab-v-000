...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, COUNT(character_books.book_id) FROM character_books JOIN characters ON characters.id = character_books.character_id ORDER BY character_books.book_id DESC;"
